...
class Drawerfile extends StatefulWidget {
  @override
  DrawerfileState createState() => DrawerfileState();
}

class DrawerfileState extends State<Drawerfile> {
        ...
        Container(
          ...
          child: Center(
            child: ListTile(
              ...
              trailing: Image.asset('assets/flutter2.png',
                  height: size.height / 20, width: size.width / 10),
            ),
          ),
        ),
        ListView.builder(
